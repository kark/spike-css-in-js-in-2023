...
const createRandomClassName = () =>
  `std-${Math.random().toString(36).substring(7)}`;
...
const styled = {};
const styleTagInstance = createStyleTag();

DOM_ELEMENTS.forEach((html) => {
  styled[html] = (stylesText, ...args) =>
    createStyledElement(html, stylesText, styleTagInstance, args);
});
